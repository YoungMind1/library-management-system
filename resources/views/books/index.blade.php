    ...
    <div class="container mx-auto py-5">
            ...
            <div class="mb-5">
                <a href="{{route('admin.books.create')}}">
                    <button type="submit" class="px-5 py-2 ml-2 mb-1 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring focus:ring-indigo-500">Add New Book</button>
                </a>
                ...
                <table class="table w-full">
                    <thead>
                        <tr class="bg-gray-51 border-b border-gray-200">
                            ...
                            <th class="px-7 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Title</th>
                            <th class="px-7 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">ISBN</th>
                        ...
                        @foreach($books as $book)
                            <tr>
                                ...
                                <td class="px-7 py-4 whitespace-nowrap">
                                    <a class="inline-block" href="{{route('admin.books.show', $book)}}">
                                    ...
                                    <a class="inline-block" href="{{route('admin.books.edit', $book)}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="20" height="20" viewBox="0 0 256 256" xml:space="preserve">
                                            <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
